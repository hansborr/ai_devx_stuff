...
import { isJsonValue, normalizeStringList } from "./baseline-hash.js";
...
import { hasNormalizedPath, metricPairingFailures } from "./registry-validation.js";
...
function formatProposeSummary(summary: ProposeSummary): string {
  return [
    ...
    "promotable config (paste into the lintRatchets array in scripts/lint-ratchet/lint-ratchet-config.ts, fill in id/principle, then run bun run lint:ratchet:update):",
