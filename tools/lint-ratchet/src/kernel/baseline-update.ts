...
type BaselineComparator = (
  ...
  ratchets: readonly LintRatchetConfig[],
  currentById: ReturnType<typeof currentByIdFromBaseline>,
) => LintRatchetComparison;

interface LintRatchetUpdateInput {
  readonly committed: LintRatchetBaseline;
  readonly generated: LintRatchetBaseline;
  readonly ratchets: readonly LintRatchetConfig[];
  readonly options: LintRatchetUpdateOptions;
...
function decideLintRatchetUpdateWithComparator(
  input: LintRatchetUpdateInput,
  compare: BaselineComparator,
): LintRatchetUpdateDecision {
  const { committed, generated, ratchets, options } = input;
  ...
  const comparison = excludeIncomparableMigratedDeltas(
    compare(committed, ratchets, currentByIdFromBaseline(generated)),
    migratedIds,
  );
