...
AI_LINT_COVERAGE_STATE_DIR="${AI_LINT_COVERAGE_STATE_DIR:-$AI_STATE_ROOT/lint-coverage}"
...
ai_cache_init() {
  mkdir -p "$AI_GIT_STATE_DIR" "$AI_BUN_STATE_DIR" "$AI_STOP_STATE_DIR" "$AI_LINT_COVERAGE_STATE_DIR" "$AI_BUN_LOG_DIR" "$AI_PRECOMMIT_LOG_DIR"
}
