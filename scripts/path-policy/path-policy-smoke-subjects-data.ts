// Pure, side-effect-free smoke-subject data. Split out of
// path-policy-smoke-subjects.ts so the flat lookup table (which grows with
// smoke tests, not logic) is not held under the local/max-lines logic floor.
// This module MUST stay free of `node:fs`/`node:path` imports and control flow;
// the directory-backed discovery logic stays in the sibling module.
...
export const SCRIPT_SMOKE_SUBJECTS = {
  ...
  "test-post-create": [".devcontainer/post-create.sh", "scripts/tests/test-post-create.sh"],
