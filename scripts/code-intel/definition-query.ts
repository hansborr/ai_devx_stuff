import type { DefinitionInfo, Project, SourceFile } from "ts-morph";
...
import { getOptionalProjectSourceFile, getProjectSourceFile } from "./source-project.js";
import type {
  DefinitionNearMatch,
...
function compareDefinitionNearMatches(left: DefinitionResult, right: DefinitionResult): number {
