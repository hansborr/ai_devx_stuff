...
export const lintedScriptEntriesA: readonly CoverageEntry[] = [
  ...
  },
  {
    ...
    globs: [
      ...
      "scripts/backlog-lint-grammar.ts",
      "scripts/backlog-lint-classify.ts",
      "scripts/backlog-catalog-render.ts",
      "scripts/generate-backlog-catalog.ts",
      "scripts/backlog-lint.test.ts",
      "scripts/backlog-lint-packs.test.ts",
      "scripts/backlog-lint-drift.test.ts",
      "scripts/backlog-lint-grammar.test.ts",
      "scripts/backlog-lint-classify.test.ts",
      "scripts/backlog-lint-status.test.ts",
      "scripts/backlog-catalog-render.test.ts",
    ],
    files: "20 .ts",
    normalLint: { covered: true, note: "`scripts/**/*.ts` default" },
    ratchets: "`ratchet/local-type-assertion-boundary`",
    parser: "ESLint `tsconfig.scripts.json`",
    proposed:
      "none — report-only backlog metadata + pack-index lint and the generated backlog catalog, with focused parser, stale-note, classifier, and renderer coverage",
    status: ["linted", "ratcheted"],
    followUp:
      "`bun run backlog:lint` checks `docs/agent_notes/backlog/**/*.md` without becoming a gate; `bun run docs:backlog-catalog[:check]` regenerates/verifies `docs/agent_notes/backlog/CATALOG.md` in the same advisory tier.",
  },
  {
