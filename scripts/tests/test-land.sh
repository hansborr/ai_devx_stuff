...
[ "$(last_line "$output")" = "land: exit: 2 (verify-failed) — fix the branch verification failure, then re-run land" ] \
...
[ "$(last_line "$output")" = "land: exit: 2 (verify-failed) — fix the merge-tree verification failure, then re-run land" ] \
