...
declare -A SMOKE_SUBJECTS=(
  ...
  [test-lint-ratchet]="scripts/lint-ratchet.ts scripts/lint-ratchet-config.ts scripts/lint-ratchet-baseline-compare.ts scripts/lint-ratchet-baseline-parse.ts scripts/lint-ratchet-baseline.ts scripts/lint-ratchet-baseline.test.ts scripts/lint-rule-docs.ts scripts/test-lint-ratchet.sh lint-ratchet.baseline.json packages/shared/src/schemas/harness-diagnostics.ts package.json tsconfig.scripts.json eslint.config.js eslint-rules/"
