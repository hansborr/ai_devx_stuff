...
**Description:** Pino logger messages must be static with dynamic values in the metadata object, and createScriptLogger may only be imported from the sanctioned server script paths
