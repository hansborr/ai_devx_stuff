...
|---|---|---|---|---|---|---|
| 10 | [protected-files deny tier bypassable via Bash writes](./10-protected-files-bash-write-bypass.md) | PG | M | high | none | Done |
| 11 | [Anchor DB CLI checks; docker prefix blind spot](./11-db-cli-anchoring-and-docker-prefixes.md) | PG | S-M | high | none | Done |
| 12 | [Destructive git guards miss global options](./12-git-global-options-bypass-destructive-guards.md) | PG | S | high | none | Done |
| 13 | [Worktree-loss policy parity for Codex/Copilot](./13-worktree-loss-policy-parity-codex-copilot.md) | PG | S-M | high | 11 (helpers) | Done |
| 14 | [CMD_START grammar gaps: widen or document](./14-cmd-start-grammar-gaps-decision.md) | PG | M | med | decision gate | Done |
| 20 | [Clamp quiet-wrapper watchdogs below hook timeout](./20-quiet-wrapper-timeout-clamp.md) | QW | S | med | none | Done |
| 21 | [Orphan child on SIGKILLed bun-run-quiet](./21-bun-quiet-orphan-child-on-sigkill.md) | QW | M | med | pair with 20, 22 | Done |
| 22 | [process-runner.sh dead code: wire or delete](./22-process-runner-dead-code.md) | QW | S | low | decide with 21 | Done |
| 23 | [prisma-generate flock error handling](./23-prisma-generate-flock-error-handling.md) | QW | S | low-med | none | Done |
| 30 | [SubagentStop init + degenerate scope key](./30-subagent-stop-init-and-scope-key.md) | SP | S-M | med | none | Done |
| 31 | [Stop-hook live ESLint vs 30s budget](./31-stop-lint-warnings-budget.md) | SP | S-M | med | none | Done |
| 32 | [session-state kill-switch listing + matcher](./32-session-state-kill-switch-listing.md) | SP | S | low-med | check R11 overlap | Done |
| 40 | [Harness freshness gate in land.sh](./40-land-harness-freshness-gate.md) | VP | S-M | high | none | Done |
| 41 | [De-dup dist-defer dispatch + typecheck assertion](./41-dist-defer-dedup-and-typecheck-assertion.md) | VP | M | med | none | Done |
| 42 | [Assert verify ⊇ pre_commit slot sets](./42-verify-superset-assertion.md) | VP | S | med | none | Done |
| 43 | [Surface classifier-uncertainty scripts skip](./43-classifier-skip-visibility.md) | VP | S | low | none | Done |
| 44 | [Bind manifest dynamic resolvers to steps-lib cases](./44-dynamic-resolver-binding-check.md) | VP | S | low-med | none | Done |
| 50 | [agent-run.sh signal race + trailer ambiguity](./50-agent-run-signal-race.md) | AC | M | med-high | none | Done |
| 60 | [Instruction-surface discovery gaps](./60-instruction-pointer-gaps.md) | DH | S | low | none | Done |
| 61 | [Temp-file leak + stop-state GC](./61-result-command-temp-leak-and-stop-state-gc.md) | DH | S | low | none | Done |
