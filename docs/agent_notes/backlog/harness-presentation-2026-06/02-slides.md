...
**Repo example:** `scripts/lint-ratchet/lint-ratchet-baseline-compare.ts` (the symmetric gate); `lint-ratchet.debt-log.jsonl` (12 retirement entries); `docs/agent_notes/lint-coverage-map.md` (~230-row owner inventory).
