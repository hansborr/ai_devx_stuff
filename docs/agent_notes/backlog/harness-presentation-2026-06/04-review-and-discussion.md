...
- **Behavior confidence is the honest gap.** The repo self-declares it the weakest axis (`docs/ai-harness.md:223`), and the literature (Böckeler) agrees functional-behavior harnessing is industry-unsolved. Mutation testing is scoped to 16 of 66 shared files and runs off-gate by design.
