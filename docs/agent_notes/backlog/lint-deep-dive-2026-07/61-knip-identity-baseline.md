...
Status: Design APPROVED by owner 2026-07-07 — implement as slice 1 of `../arch-review-2026-07/12-baseline-framework-and-max-lines.md` (framework extraction + this sensor as first consumer), queued behind the agent-cli consolidation pack. Do not implement standalone.
