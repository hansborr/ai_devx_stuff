#!/bin/bash
# Thin adapter - semantics documented in scripts/ai-hooks/ratchet-regression-check.sh; Copilot
...
ai_copilot_dispatch post-edit edit "$HOOK_LIB/ratchet-regression-check.sh"
