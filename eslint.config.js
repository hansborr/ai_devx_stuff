...
export default defineConfig(
  ...
  // Max-lines warn caps for scripts tracked by the max-lines ratchet.
  { files: ["scripts/drift-ai.ts"], rules: { "local/max-lines": ["warn", { max: 1110, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/drift-ai/config.ts"], rules: { "local/max-lines": ["warn", { max: 470, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/drift-ai/duplicates.ts"], rules: { "local/max-lines": ["warn", { max: 440, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/drift-ai/ghost-files.ts"], rules: { "local/max-lines": ["warn", { max: 610, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/drift-ai/harness-freshness.ts"], rules: { "local/max-lines": ["warn", { max: 340, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/drift-ai/suppressions.ts"], rules: { "local/max-lines": ["warn", { max: 470, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/generate-harness-controls.ts"], rules: { "local/max-lines": ["warn", { max: 390, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/harness-check.ts"], rules: { "local/max-lines": ["warn", { max: 450, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/lint-ratchet-baseline.ts"], rules: { "local/max-lines": ["warn", { max: 730, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/lint-ratchet.ts"], rules: { "local/max-lines": ["warn", { max: 840, skipBlankLines: true, skipComments: true }] } },
  { files: ["scripts/logs-audit.ts"], rules: { "local/max-lines": ["warn", { max: 690, skipBlankLines: true, skipComments: true }] } },
